...
FSCLIENT = 'file:///home/qlaportechabasse/client-netflux-lxc.tar.gz'
FSSIGVER = 'file:///home/qlaportechabasse/sigver.tar.gz'
GATEWAY  = '10.147.255.254' # Default gateway of Nancy's sites
NETFLUXHOST = 'https://coast-team.github.io/netflux-demo/grid5000.html'
SERVER_PORT = 5000
SAVE_DIR = '/tmp/'
...
duration = 1200 # time unit : seconde
